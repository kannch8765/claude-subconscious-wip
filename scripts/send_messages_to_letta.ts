...
- Each memory_search hit is marked session_delivery=new or session_delivery=already_delivered for this Claude session. Prefer new for foreground continuity. already_delivered memories remain searchable for private maintenance, but do not call deliver_whisper with them again in the same session.
